...
const SendPlayerInviteHome = (props)=>{
                  ...
                  <View style={{paddingTop: '7.5%'}}>
                    <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#111', '#111']} style={styles.linearGradientText}>
                      <Heading style={{color: '#fff', textAlign: 'left', paddingBottom: 0, paddingLeft: 0, paddingTop: 0, paddingRight: 20}}>
                        Share Live Scores & Stats
                      </Heading>
                      <Text style={{color: '#fff'}}>Tap 'Copy Invite - Entire Team' to copy the invite to your clipboard. The invite includes a Team ID and player IDs, allowing players and parents to view live scores & stats. Once copied, paste the text into a your team group-chat to send the invite to your team.</Text>
                    </LinearGradient>
                    { teamNames.length > 0 &&
                      <Box>
                    <Text style={{marginBottom: 0, color: '#fff'}}>Select your Team and Season to display player invites.</Text>
                      ...
                      { teamNames.length <= 0 &&
                        <Box>
                        <Text style={{marginBottom: 0, color: '#fff', paddingBottom: 10}}>PLEASE READ: You must add a team before you can send Player Invites. To add a team, press 'home' below and tap 'Step 1'.</Text>
                    ...
                    {oppTeamId > 0 &&
                      <TeamPlayerInvites navigation={props.navigation} playerData={playerData} team={oppTeam} teamId={oppTeamId} season={season} seasonId={seasonId} whereFrom={88} />
                    }
                  </ScrollView>
                  {getDisplayCopied()}
                </Container>
...
export default SendPlayerInviteHome;
