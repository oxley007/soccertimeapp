...
const imageUrl = '../../assets/Step_1_instructions.gif';
            ...
            <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#e879f9', '#a855f7']} style={styles.linearGradientBg}>
              <Center style={{minWidth: "100%", height: '100%'}}>
                ...
                <Box style={styles.instructionBoxTop}>
                  <Text><Text style={{fontWeight: '900', paddingBottom: 10}}>(1)</Text> Tap on the player on the field screen to add a 'goal', 'assist', 'tackle' or 'goalie save'</Text>
                  <Text><Text style={{fontWeight: '900'}}>(2)</Text> Tap the relevant button to record the stat. Note: tapping ‘Goal’ will auto add 1 goal to your team's score</Text>
                </Box>
                <Center>
                <Image
                    style={styles.screenshotImage}
                    source={require('../../assets/Step_1_instructions.gif')}
                  />
                </Center>
                </Box>
                </Container>
              ...
              <Box bg="tertiary.100" style={{zIndex: 3, elevation: 3, borderBottomColor: '#fff', borderBottomWidth: 1, minHeight: 100}}>
                ...
                <Button variant="unstyled">
                  <HStack >
                  <Center pl="2">
                    <Text style={styles.textTwentyFour}>1 of 6</Text>
                    </Center>
                  </HStack>
                </Button>
