            ...
            <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#e879f9', '#a855f7']} style={styles.linearGradientBg}>
              <Center style={{minWidth: "100%", height: '100%'}}>
                ...
                <Center>
                  <Image
                      ...
                      source={require('../../assets/Step_3_instructions.gif')}
                    />
                </Center>
                <Box style={styles.instructionBoxBottom}>
                  <Text>If you need to substitute a player, simpley press-and-hold on a player and drag them off the playing field <Text style={{fontWeight: '900'}}>(1)</Text>. You then repeat the process to replace the player by dragging a substitute onto the playing field <Text style={{fontWeight: '900'}}>(2)</Text>.</Text>
                </Box>
                </Box>
                </Container>
              ...
              <Box bg="tertiary.100" style={{zIndex: 3, elevation: 3, borderBottomColor: '#fff', borderBottomWidth: 1, minHeight: 100}}>
                ...
                <Button variant="unstyled">
                  <HStack >
                  <Center pl="2">
                    <Text style={styles.textTwentyFour}>3 of 6</Text>
                    </Center>
                  </HStack>
                </Button>
