            ...
            <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#e879f9', '#a855f7']} style={styles.linearGradientBg}>
              <Center style={{minWidth: "100%", height: '100%'}}>
                ...
                <Box style={styles.instructionBoxTop}>
                  <Text style={{paddingBottom: 10}}>You can add an own-goal scored by the opposition team by pressing the own-goal button at the bottom of the screen <Text style={{fontWeight: '900'}}>(1)</Text>. This adds a goal to the your team.</Text>
                  <Text style={{paddingBottom: 10}}>You can see all the game events by pressing the ‘Game events’ button at the bottom of the screen <Text style={{fontWeight: '900'}}>(2)</Text>. Please make sure you send email invites to your team (can be sent from a button on the homescreen) so that all players, parents and fans can watch live game events!</Text>
                  <Text>If you need to complete the game early, press the ‘exit game’ button to complete the game <Text style={{fontWeight: '900'}}>(3)</Text>. Or, let the game clock run and you can complete the game once the game-time has been completed.</Text>
                </Box>
                <Center>
                  <Image
                      style={styles.screenshotImage}
                      source={require('../../assets/Step_6_instructions.gif')}
                    />
                </Center>
                </Box>
                </Container>
              ...
              <Box bg="tertiary.100" style={{zIndex: 3, elevation: 3, borderBottomColor: '#fff', borderBottomWidth: 1, minHeight: 100}}>
                ...
                <Button variant="unstyled">
                  <HStack >
                  <Center pl="2">
                    <Text style={styles.textTwentyFour}>6 of 6</Text>
                    </Center>
                  </HStack>
                </Button>
...
const styles = StyleSheet.create({
  ...
  instructionBoxTop: {
    position: 'absolute', top: '35%', zIndex: 1, backgroundColor: '#fff', padding: 15, minWidth: '100%'
  },
