...
const exclamationcircle = <Icon name="exclamationcircle" size={20} color="red" />;
const exclamationcircleLarge = <Icon name="exclamationcircle" size={40} color="red" />;
import LinearGradient from 'react-native-linear-gradient';


const StepImportant = (props)=>{
            ...
            <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#e879f9', '#a855f7']} style={styles.linearGradientBg}>
              <Center style={{minWidth: "100%", height: '100%'}}>
                ...
                <Box style={styles.instructionBoxTop}>
                  <Text style={{paddingBottom: 10, fontWeight: 500}}>{exclamationcircle}   IMPORTANT PLESAE READ!</Text>
                  <Text style={{paddingBottom: 10}}>For any player in your squad who are NOT participating in the current game, move them to the red area <Text style={{fontWeight: '900'}}>(1)</Text>.</Text>
                  <Text style={{paddingBottom: 10}}>This will ensure that no time is assigned against that player (i.e the app will make sure a player does not show their time as 100% substitute, when in fact they are ‘Did Not Play’ or DNP).</Text>
                  <Text>Moving a DNP squad member to the red area will keep the player’s season stats correct.</Text>
                </Box>
                <Center>
                  <Image
                      style={styles.screenshotImage}
                      source={require('../../assets/Step_Important.gif')}
                    />
                </Center>
                </Box>
                </Container>
              ...
              <Box bg="tertiary.100" style={{zIndex: 3, elevation: 3, borderBottomColor: '#fff', borderBottomWidth: 1, minHeight: 100}}>
                ...
                <Button variant="unstyled">
                  <HStack >
                  <Center pl="2">
                    <Text style={styles.textTwentyFour}>{exclamationcircleLarge}</Text>
                    </Center>
                  </HStack>
                </Button>
