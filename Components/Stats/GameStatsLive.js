  ...
  const closeStatsBox = () => {
    ...
    dispatch(updateGameOptionBoard(false, 0))
        ...
        return (
          ...
          <VStack minW="25%">
          <Center>
            <Button p="0" mt="5" pl="5" variant="unstyled" _text={{color: '#fff', textDecorationLine: true}} onPress={() => closeStatsBox()}>
              Close
            </Button>
            </Center>
          </VStack>
          ...
          <HStack>
            ...
            <Box minW="18.5%"alignSelf="center" mt="3">
              <Button bg="yellow.100" _pressed={{ backgroundColor: 'yellow.100', opacity: 1 }} pl="1" pr="1" minW="18.5%" size="xs" style={{borderRadius: 0}}><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>MID</Text><Text style={{color: '#0891b2', fontSize: 10, textAlign: 'center', lineHeight: 0}}>{formattedSeconds(getMidTime)}min</Text><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>({getMidPercent}%)</Text></Button>
            </Box>
            <Box minW="18.5%"alignSelf="center" mt="3">
              <Button bg="warning.200" _pressed={{ backgroundColor: 'warning.200', opacity: 1 }} pl="1" pr="1" minW="18.5%" size="xs" style={{borderRadius: 0}}><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>DEF</Text><Text style={{color: '#0891b2', fontSize: 10, textAlign: 'center', lineHeight: 0}}>{formattedSeconds(getDefTime)}min</Text><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>({getDefPercent}%)</Text></Button>
            </Box>
            <Box minW="18.5%" alignSelf="center" mt="3">
              <Button bg="fuchsia.200" _pressed={{ backgroundColor: 'fuchsia.200', opacity: 1 }} pl="1" pr="1" minW="18.5%" size="xs" style={{borderRadius: 0}}><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>GOL</Text><Text style={{color: '#0891b2', fontSize: 10, textAlign: 'center', lineHeight: 0}}>{formattedSeconds(getGolTime)}min</Text><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>({getGolPercent}%)</Text></Button>
            </Box>
            <Box minW="18.5%"alignSelf="center" mt="3">
              <Button bg="emerald.200" _pressed={{ backgroundColor: 'emerald.200', opacity: 1 }} pl="1" pr="1" minW="18.5%" size="xs" style={{borderTopLeftRadius: 0, borderBottomLeftRadius: 0}}><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>SUB</Text><Text style={{color: '#0891b2', fontSize: 10, textAlign: 'center', lineHeight: 0}}>{formattedSeconds(getSubTime)}min</Text><Text style={{color: '#0891b2', fontSize: 12, textAlign: 'center', lineHeight: 0}}>({getSubPercent}%)</Text></Button>
            </Box>
          </HStack>
          <HStack>
          ...
          {isOpen === true &&
            <Box>
          <HStack>
            <SeasonStats playerData={null} statsPlayerId={statsPlayerId} whereFrom={1}/>
          </HStack>
          <HStack>
            <SeasonPositionStats playerData={null} statsPlayerId={statsPlayerId} whereFrom={1}/>
          </HStack>
          </Box>
          }
          {isOpen === false &&
